        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('owner.flats.update', $flat) }}" method="POST">
                        @csrf @method('PUT')
                            ...
                            <div class="col-9">
                                <select name="building_id" class="form-control" required>
                                    ...
                                    @forelse($buildings as $b)
                                        <option value="{{ $b->id }}" {{ old('building_id', $flat->building_id) == $b->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="email" name="flat_owner_email" class="form-control"
                                    value="{{ old('flat_owner_email', $flat->flat_owner_email) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <input type="submit" class="btn btn-primary" value="Update Flat" name="btn">
                            </div>
                        </div>
                    </form>
                </div>
